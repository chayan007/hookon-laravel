...
@foreach ($internships as $internship)
     <div class="box box-danger collapsed-box">
        ...
        <div class="box-body">
          <form method="POST" action="/recruiter/edit/{{ $internship->id }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                <label for="">Company Name</label>
                <input type="text" class="form-control" name="company" id="" aria-describedby="helpId" placeholder="{{ $internship->company }}">
                ...
                <input type="text" class="form-control" name="url" id="" aria-describedby="helpId" placeholder="{{ $internship->url }}">
                <small id="helpId" class="form-text text-muted">Just so interns could check you out</small>
                </div>
                <div class="form-group">
                <label for="">Mobile</label>
                <input type="text" class="form-control" name="phone" id="" aria-describedby="helpId" placeholder="{{ $internship->phone }}">
                <small id="helpId" class="form-text text-muted">We will text you</small>
                </div>
                <div class="form-group">
                <label for="">Skills</label>
                <input type="text" class="form-control" name="skills" id="" aria-describedby="helpId" placeholder="{{ $internship->skills }}">
                <small id="helpId" class="form-text text-muted">Just to see where you work</small>
                </div>
                <div class="form-group">
                <label for="">Description</label>
                <textarea class="form-control" name="desc" id="" rows="5" placeholder="{{ $internship->desc }}"></textarea>
                <small id="helpId" class="form-text text-muted">Just to know what Interns will be working on</small>
                </div>
                <div class="form-group">
                <label for="">About Company</label>
                <textarea class="form-control" name="desc" id="" rows="5" placeholder="{{ $internship->about }}"></textarea>
                ...
                <input type="number" class="form-control" name="duration" aria-describedby="helpId" placeholder="{{ $internship->duration }}">
                <small id="helpId" class="form-text text-muted">Just to let interns know about it</small>
                </div>
                <div class="form-group">
                <label for="">Stipend</label>
                <input type="number" class="form-control" name="stipend" aria-describedby="helpId" placeholder="{{ $internship->stipend }}">
