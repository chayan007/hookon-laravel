                   ...
                   <div class="row">
                               <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="" id="" aria-describedby="helpId" aria-label="Large" placeholder="I want courses for ....">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="" id="" aria-describedby="helpId" aria-label="Large" placeholder="I want courses at .....">
